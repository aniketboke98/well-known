...
<div class="row justify-content-center">
    <div class="col-lg-6">
        ...
        <?php endif; ?>
        <div class="card">
            <div class="card-header p3 bg-danger text-white">
                <div class="row">
                    <div class="col pt-1">
                        Create License
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    <label for="duration" class="form-label">Duration Of Key</label>
                ...
                <div class="form-group mb-3">
                    <label for="estimation" class="form-label">Your Total Balance</label>
                    <input type="text" id="estimation" class="form-control" placeholder="Your order will total" readonly>
                </div>
                <div class="form-group">
                    <button type="submit" class="btn btn-outline-primary">Generate Your Key</button>
                </div>
                <?= form_close() ?>
