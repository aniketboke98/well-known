...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card mb-3">
            <div class="card-header h6 p-3 bg-success text-white">
                Change Password
            </div>
            <div class="card-body">
                <?= form_open() ?>
                ...
                <div class="form-group mb-2">
                    ...
                    <?php if ($validation->hasError('password')) : ?>
                        <small id="help-password" class="text-danger"><?= $validations->getError('password') ?></small>
                    <?php endif; ?>
                </div>
                <div class="form-group mb-2">
                ...
                <div class="form-group my-2">
                    <button type="submit" class="btn btn-outline-success">Change Your Password</button>
                </div>
                <?= form_close() ?>
            </div>
        </div>
    ...
    <div class="col-lg-6">
        <div class="card mb-3">
            <div class="card-header h6 p-3 bg-danger text-white">
                Accont Information
            </div>
            <div class="card-body">
                <?= form_open() ?>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="fullname" id="fullname" class="form-control mt-2" placeholder="RedZONERROR" aria-describedby="help-fullname" value="<?= old('fullname') ?: ($user->fullname ?: '') ?>">
                    <?php if ($validation->hasError('fullname')) : ?>
                        <small id="help-fullname" class="text-danger"><?= $validation->getError('fullname') ?></small>
                    <?php endif; ?>
                </div>
                <div class="form-group my-2">
                    <button type="submit" class="btn btn-outline-primary">Updat Account Name</button>
                </div>
                <?= form_close() ?>
            </div>
        </div>
