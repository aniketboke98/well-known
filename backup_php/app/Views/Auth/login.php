    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow-sm mb-5">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="password" class="form-control mt-2" name="password" id="password" aria-describedby="help-password" placeholder="Your password" required minlength="5">
                ...
                <div class="form-group mb-2">
                    <button type="submit" class="btn btn-outline-primary"><i class="bi bi-box-arrow-in-right"></i> Login now</button>
                </div>
                <?= form_close() ?>
            </div>
        </div>
        ...
        <p class="text-center text-muted after-card">
            <small class="bg-white px-auto p-2 rounded">
                Login problem?
                <a href="<?= site_url('reset') ?>" target="_blank" class="text-success">Reset here</a>
            </small>
        </p>
        ...
        <p class="text-center text-muted after-card">
            <small class="bg-white px-auto p-2 rounded">
                ...
                <a href="<?= site_url('register') ?>" class="text-success">Register here</a>
            </small>
        </p>
