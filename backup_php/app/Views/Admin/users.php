...
<div class="row">
    <div class="col-lg-12">
        <div class="alert alert-primary" role="alert">
            <strong>INFO</strong> &middot; Search specify user by their (username, fullname, balance or uplink).
        </div>
        <div class="card shadow-sm">
            <div class="card-header bg-danger text-white h6 p-3">
                Manage <?= $title ?>
            </div>
            <div class="card-body">
                <!-- <?php if ($user_list) : ?> -->
        ...
        var table = $('#datatable').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    data: null,
                    render: function(data, type, row, meta) {
                        return `<a  href="<?= site_url('/admin/user/') ?>${row.id}" class="btn btn-success text-primary btn-sm">EDIT</a>`;
                    }
                }
            ]
        });
