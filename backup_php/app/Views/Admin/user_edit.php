...
<div class="row justify-content-center pt-3">
    ...
    <div class="col-lg-8 mb-3">
        <div class="card mb-5">
            <div class="card-header p-3 h5 bg-danger text-white">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="uplink" id="uplink" disabled="disabled" class="form-control" placeholder="" aria-describedby="help-uplink" value="<?= old('uplink') ?: $target->uplink ?> ">
                    ...
                    <div class="col-md-12 mt-2">
                        <button type="submit" class="btn btn-outline-primary">Update Account Information</button>
                    </div>
                </div>
                <?= form_close() ?>
